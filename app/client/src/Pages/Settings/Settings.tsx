            ...
            <div className="info_edit px-8 py-10">
                <figure className='flex items-center gap-16'>
                    ...
                    <div id='avatar-editor' className='relative mx-5 '>
                        ...
                        <button className=' bg-pink-500 hover:bg-pink-600 py-2 px-8 rounded-md'>update</button>
                </figure>
                <article>
                    <form className=' p-10 flex'>
                        ...
                        <button className='bg-pink-500 hover:bg-pink-600 ml-10 px-6 py-8 self-center rounded-md'>
                            <img width="50" height="50" src="https://img.icons8.com/fluency/48/save.png" alt="save"/>
                        </button>
                    </form>
                </article>
            </div>
